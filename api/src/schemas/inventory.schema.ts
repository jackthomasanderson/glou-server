...
export const inventoryPatchSchema = z.object({
  ...
  peakMaturity: z.string().max(100).optional().nullable(),
  peakMaturityFrom: z.number().int().min(1800).max(2200).optional().nullable(),
  peakMaturityTo: z.number().int().min(1800).max(2200).optional().nullable(),
  ...
  sparklingType: z.string().max(100).optional().nullable(),
  sugarLevel: z.string().max(50).optional().nullable(),
  ...
  declaredAge: z.string().max(50).optional().nullable(),
  ...
  sealedStatus: z.enum(['sealed', 'opened']).optional().nullable(),
