...
Exemples minimaux pour Nginx et Caddy afin d'exposer Glou en HTTPS et transmettre les IP clients. Activez `TRUST_PROXY_HEADERS=true` côté Glou uniquement derrière ce proxy.
...
## Variables d'environnement Glou
```
